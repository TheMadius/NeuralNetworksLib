...
void ModelView::LoadTexturesAndText()
{
	...
	//спрайты для шашек
	//windowGame->gameTextureAndText.blackСheckerSprite = new Sprite[COUNT_CHECKER];
	//windowGame->gameTextureAndText.whiteСheckerSprite = new Sprite[COUNT_CHECKER];
	...
	windowGame->gameTextureAndText.blackСhecker.loadFromFile("..\\Debug\\textures\\blackCh.png");
	windowGame->gameTextureAndText.whiteСhecker.loadFromFile("..\\Debug\\textures\\whiteCh.png");
